...
(function() {
  var ActivationAgePolicy, Adaptation, Context, Manager, Namespace, Policy, contexts, ensureObject, exports, findScriptHome, strategies, traceableMethod, traceableTrait, traits, _base,
  ...
  if ((_base = Function.prototype).inheritFrom == null) {
  ...
  Context = function(name) {
    ...
    this.adaptations = [];
    this.manager = ((_ref = contexts.Default) != null ? _ref.manager : void 0) || new Manager();
    if (name != null) {
      this.name = (function() {
        return name;
      });
  ...
  _.extend(Context.prototype, {
    ...
    activateAdaptations: function() {
      var adaptation, _i, _len, _ref, _results;
      _ref = this.adaptations;
      _results = [];
  ...
  _.extend(Manager.prototype, {
    ...
    withdrawAdaptation: function(adaptation) {
      ...
      if (i === -1) throw new Error("Attempt to withdraw unmanaged adaptation");
  ...
  traits.Extensible = Trait({
    proceed: function() {
      var alternatives, args, index, invocations, manager, method, name, _ref;
      ...
      _ref = invocations.top(), name = _ref[0], args = _ref[1], method = _ref[2];
  ...
  Namespace = function(name, parent) {
    ...
    if (!name) throw new Error("Namespaces must have a name");
    this.name = name;
    this.parent = parent;
    if (!parent) this.home = findScriptHome();
    return this;
  };
    ...
    loadInBrowser: function(path, success, failure) {
      ...
      return $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
          ...
          try {
            if (window.hasOwnProperty('exports')) origExports = window.exports;
            window.exports = {};
            $.globalEval(data);
  ...
  _.extend(Context.prototype, {
    path: function(from) {
      var i, keys, p, subspace, values, _len;
  ...
  findScriptHome = function() {
    var line, matches, trace, _i, _len, _ref;
    try {
      throw new Error;
    } catch (error) {
      ...
      if (trace) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (matches != null) return matches[2];
        }
